...
Ниже приведена история запросов на разработку, ответов и консольных выводов, начиная с запроса на добавление цветового пространства CIELAB и создание реализации приложения.
